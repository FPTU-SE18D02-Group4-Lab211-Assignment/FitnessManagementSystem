...
public class Course {
    ...
    public Course(String courseID, String courseName, String courseDescription, int courseDuration, double coursePrice, Coach coachID, List<Workout> listOfWorkout) {
    ...
    public List<Workout> getListOfWorkout() {
        return listOfWorkout;
    }

    public void setListOfWorkout(List<Workout> listOfWorkout) {
        this.listOfWorkout = listOfWorkout;
    }
